...
const tests = [
    {
        question: "tests.day4.test1.question",
        answers: ["tests.day4.test1.a", "tests.day4.test1.b", "tests.day4.test1.c", "tests.day4.test1.d"],
        correct: 2
    },
    {
        question: "tests.day4.test2.question",
        answers: ["tests.day4.test2.a", "tests.day4.test2.b", "tests.day4.test2.c", "tests.day4.test2.d"],
        correct: 3
    },
    {
        question: "tests.day4.test3.question",
        answers: ["tests.day4.test3.a", "tests.day4.test3.b", "tests.day4.test3.c", "tests.day4.test3.d"],
        correct: 2
    }
]
